                ...
                >
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      ...
                      >
                        <Trash2
                          className="text-black group-hover:text-pink-600"
                          size={20}
                        />
                      </button>
                   ...
                   <button
                      ...
                      try {
                        ...
                        text: paste?.content?.slice(0, 100) || "View this paste",
                   ...
                   >
                   <Share2 className="text-black group-hover:text-green-500" size={20} />
                  </button>
    



                      <button className="p-2 rounded-[0.2rem] bg-white border border-[#c7c7c7]  hover:bg-transparent group hover:border-orange-600">
